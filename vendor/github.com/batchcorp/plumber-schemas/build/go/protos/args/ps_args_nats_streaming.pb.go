...
type NatsStreamingTLSOptions struct {
	...
	// @gotags: kong:"help='Connect using TLS',env='PLUMBER_RELAY_NATS_STREAMING_USE_TLS'"
	UseTls               bool     `protobuf:"varint,5,opt,name=use_tls,json=useTls,proto3" json:"use_tls,omitempty" kong:"help='Connect using TLS',env='PLUMBER_RELAY_NATS_STREAMING_USE_TLS'"`
