...
type KafkaConn struct {
	...
	Addresses []string `protobuf:"bytes,1,rep,name=addresses,proto3" json:"addresses,omitempty" kong:"help='Kafka broker address (you may specify this flag multiple times)',env=PLUMBER_RELAY_KAFKA_ADDRESS,default='localhost:9092',required"`
...
func (m *KafkaConn) GetAddresses() []string {
	if m != nil {
		return m.Addresses
	}
	return nil
...
var fileDescriptor_5f98a21d9d819f0c = []byte{
	...
	,
}
