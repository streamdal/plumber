...
type DynamicOptions struct {
	...
	XGrpcAddress string `protobuf:"bytes,3,opt,name=_grpc_address,json=GrpcAddress,proto3" json:"_grpc_address,omitempty" kong:"help='Dynamic destination API address',default='dproxy.batch.sh:443'"`
	// @gotags: kong:"help='Dynamic destination collector initial connection timeout',default=5"
	XGrpcTimeoutSeconds uint32 `protobuf:"varint,4,opt,name=_grpc_timeout_seconds,json=GrpcTimeoutSeconds,proto3" json:"_grpc_timeout_seconds,omitempty" kong:"help='Dynamic destination collector initial connection timeout',default=5"`
	...
	// CLI dynamic replays will be treated as ephemeral.
	// @gotags: kong:"-"
	Name string `protobuf:"bytes,6,opt,name=name,proto3" json:"name,omitempty" kong:"-"`
	// ID of the created dynamic replay entry; populated by plumber.
	// @gotags: kong:"-"
	XDynamicId string `protobuf:"bytes,1000,opt,name=_dynamic_id,json=DynamicId,proto3" json:"_dynamic_id,omitempty" kong:"-"`
	// Set by CreateDynamic() StopDynamic() and ResumeDynamic() methods in Plumber
	// @gotags: kong:"-"
...
func (m *DynamicOptions) GetConnectionId() string {
	if m != nil {
...
func (m *DynamicOptions) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *DynamicOptions) GetXDynamicId() string {
	if m != nil {
		return m.XDynamicId
	}
	return ""
...
func (m *DynamicOptions) GetXActive() bool {
	if m != nil {
		return m.XActive
	}
	return false
...
var fileDescriptor_11709e700f0eb834 = []byte{
	...
	,
}
