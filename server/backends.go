...
//	default:
//		return fmt.Errorf("unrecognized backend for connection id '%s'", connectionID)
//	}
//}
...
//func (s *Server) getBackendRead(read *protos.Read) (*kafka.KafkaReader, error) {
//	connCfg := s.PersistentConfig.GetConnection(read.ConnectionId)
//	if connCfg == nil {
...
//func (s *Server) getBackendWrite(req *protos.WriteRequest) (*kafka.KafkaWriter, error) {
//	connCfg := s.PersistentConfig.GetConnection(req.ConnectionId)
//	if connCfg == nil {
//		return nil, errors.New("connection does not exist")
//	}
//
